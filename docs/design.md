...
fsdotnet is a tool you keep open, not a page you visit. Everything below follows from that:
...
that site puts in every card; fsdotnet descriptions are written to fit one line, so the whole
